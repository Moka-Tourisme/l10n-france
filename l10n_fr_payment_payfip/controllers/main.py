...
class PayFIPController(http.Controller):
    ...
    @http.route(_payment_url, type='http', auth='none', methods=['GET', 'POST'], csrf=False)
    ...
    @http.route(_notification_url, type='http', auth='none', methods=['POST'], csrf=False)
