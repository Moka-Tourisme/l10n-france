...
class PayFIPAcquirer(models.Model):
    ...
    def payfip_get_id_op_from_web_service(self, email, price, object, acquirer_reference):
        ...
        urlnotif = '%s' % urllib.parse.urljoin("https://tchai.mokatourisme.dev", PayFIPController._notification_url)
        urlredirect = '%s' % urllib.parse.urljoin("https://tchai.mokatourisme.dev", PayFIPController._return_url)
