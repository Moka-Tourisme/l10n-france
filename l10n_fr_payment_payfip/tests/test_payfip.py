...
class PayFIPTest(PayFIPCommon):
    ...
    def test_processing_values(self):
        ...
        self.assertEqual(
            redirect_form_data['action'], self.acquirer.payfip_get_form_action_url())
    ...
    def test_feedback_processing(self):
        ...
        self.assertEqual(tx.acquirer_reference, '088655675121650',
    ...
    def test_payfip_webservice(self):
        payfip_webservice_enable = self.acquirer._check_payfip_customer_number()
